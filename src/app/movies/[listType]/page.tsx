...
import { MediaCategoryKeyType, VALID_MEDIA_TYPES } from "@/utils/constants";

type PageProps = {
  params: Promise<{
    listType: MediaCategoryKeyType; // it is okay as long as i am validating the possibility of being invalid
  }>;
