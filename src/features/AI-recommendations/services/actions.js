...
export async function getAIRecommendations(watchedList, prevRecommendations) {
  try {
    ...
    const { recommendations } = JSON.parse(message.content);
    ...
    // 6- filter all null values form responses
