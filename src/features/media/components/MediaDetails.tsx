...
function MediaDetails({ children }: ChildrenType) {
  return <div className="space-y-4">{children}</div>;
}

function Info({ children, className = "" }: ChildrenType & ClassNameType) {
  return <div className={`space-y-1 ${className}`}>{children}</div>;
}

function Images({ backDropImage = "", posterImage = "" }: ImagesType) {
  return (
...
function Actions({ children, className = "" }: ChildrenType & ClassNameType) {
  return (
...
function Overview({ children, className = "" }: ChildrenType & ClassNameType) {
  return (
...
function Director({ children, className = "" }: ChildrenType & ClassNameType) {
  return (
    children && (
...
function TopActors({ children, className = "" }: ChildrenType & ClassNameType) {
  return (
    children && (
